...
from user_operation.views import UserFavViewSet, OrderViewSet, OrderDetailViewSet, OrderImageViewSet
...
router.register(r'order-file-upload', OrderImageViewSet, base_name='orderfileupload')
