...
class UserPermissionsName(models.Model):
	...
	permission_sn = models.CharField(max_length=20,null=True, blank=True, verbose_name="权限代码", help_text="权限代码")
	permission_desc = models.CharField(max_length=200, null=True, blank=True, verbose_name="权限描述", help_text="权限描述")
