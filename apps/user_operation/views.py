...
class OrderViewSet(mixins.ListModelMixin, mixins.UpdateModelMixin, mixins.CreateModelMixin, mixins.DestroyModelMixin,
	...
	def create(self, request, *args, **kwargs):
		...
		if serializer.is_valid(raise_exception=True):
			...
			# print(serializer.validated_data['user_info'].user_to_company)
			# print(serializer.validated_data['default_services'])
			# print(DefaultServices.objects.get(service_sn=default_services_tmp).service_belong_to_company)
			...
			serializer.validated_data['order_amount'] = order_amount
