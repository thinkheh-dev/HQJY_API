...
class OrderInfo(models.Model):
    ...
    user_info = models.ForeignKey(User, on_delete=models.CASCADE, related_name="user_order_info", verbose_name="用户",
                                  help_text="用户")
    order_belong_company = models.ForeignKey(BasicEnterpriseInfo, on_delete=models.CASCADE, blank=True, null=True,
                                             related_name="order_to_enterprise", verbose_name="订单所属企业")
    ...
    order_amount = models.FloatField(default=0, editable=True, verbose_name="订单金额", help_text="订单金额")
