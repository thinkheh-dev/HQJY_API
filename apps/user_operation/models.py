...
class ShoppingCart(models.Model):
	...
	购物车模型
	"""
	user_info = models.ForeignKey(UserInfo, on_delete=models.CASCADE, verbose_name="用户", help_text="用户")
	default_services = models.ForeignKey(DefaultServices, on_delete=models.CASCADE, verbose_name="普适服务", help_text="普适服务")
	default_services_package = models.ForeignKey(DefaultServicesPackage, on_delete=models.CASCADE, verbose_name="普适项目包", help_text="普适项目包")
...
class OrderInfo(models.Model):
	...
	user_info = models.ForeignKey(UserInfo, on_delete=models.CASCADE, related_name="user_order_info", verbose_name="用户", help_text="用户")
	...
	order_status = models.CharField(max_length=50, choices=ORDER_STATUS, verbose_name="交易状态", help_text="交易状态")
	...
	default_service_coupon = models.ManyToManyField(DefaultServiceCoupon, verbose_name="可用优惠券", help_text="可用优惠券")
	pay_time = models.DateTimeField(default=timezone.now, verbose_name="支付时间", help_text="支付时间")
	enterprise_info_service = models.ForeignKey(BasicEnterpriseInfo, on_delete=models.CASCADE, verbose_name="企业信息外键", help_text="企业信息外键")
	...
	industry_commissioner = models.ForeignKey(UserInfo, on_delete=models.CASCADE, related_name="industry_order_info",
	                                          verbose_name="分配行业专员", help_text="分配行业专员")
...
class OrderServiceDetail(models.Model):
	...
	订单商品详情
	"""
	order_info = models.ForeignKey(OrderInfo, on_delete=models.CASCADE, verbose_name="订单信息外键", help_text="订单信息外键")
	default_services = models.ForeignKey(DefaultServices, on_delete=models.CASCADE, verbose_name="普适服务外键", help_text="普适服务外键")
	default_services_package = models.ForeignKey(DefaultServicesPackage, on_delete=models.CASCADE, verbose_name="普适服务包外键", help_text="普适服务包外键")
